...
default_biochar = Dict([:flash_αβγ => [8.82115e9, 299 * 10^(3*0.5903), 0.5903], # flash parameters (α, β, γ)
                       ...
                       :BulkDensity => 500.0, # kg/m3 (Birch)
                       :CharHeatCapacity => 1750.0]) # J / (kg K) 
                       
# default_lignin = Dict([:c₀ => 0.06,
#                        :p₀ => 0.54,
#                        :σ => 3.98,
#                        :mb => 67.0/1000.0,
#                        :ma => 1917.0/1000.0,
#                        :b_rate => [7.0e15, 55400.0,  500.0], #@@@@@
#                        :g_rate => [2.3e15, 69000.0, 2600.0], #
#                        :ρ_rate => 0.9,
...
default_cellulose = Dict([:c₀ => 0.0,
                          ...
                          :mb => 45.4/1000.0,
                          :ma => 81.0/1000.0,
                          :b_rate => [2.0e15, 55400.0, 4100.0], #:b_rate => [2.0e16, 55400.0, 4100.0],
...
default_hemicellulose = Dict([:c₀ => 0.0,
                              ...
                              :mb => 43.0/1000.0,
                              :ma => 77.5/1000.0,
                              :b_rate => [1.2e15, 51500.0, 100.0], #:b_rate => [1.2e20, 51500.0, 100.0],
